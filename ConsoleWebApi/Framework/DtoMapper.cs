    ...
    public class DtoMapper : IFMapper
    {
        ...
        public static IConfigurationProvider CreateConfig()
        {
            return new MapperConfiguration(x =>
            {
                ...
                x.DoubleMap<BAccurate.Models.Resource.ResourceInfo, ResourceEntity>();
                ...
                x.CreateMap<UserEntity, BAccurate.Models.User.UserInfo>();
                x.CreateMap<BAccurate.Models.User.UserParam, UserEntity>();
                var roleUserMap = x.CreateMap<RoleEntity, BAccurate.Models.User.RoleInfoOfUser>();
