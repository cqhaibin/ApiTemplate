 ...
 * LocDepartInfo
 */
export class LocDepartInfoMgr{
    public changeEvents:Array<any>;
    private list:Array<any>;
    public axios:any;
    private listUrl:string = '/api/LocDepartInfo/GetAll';
    private saveUrl:string = '/api/LocDepartInfo/PostSave';
    private removeUrl:string = '/api/LocDepartInfo/Remove';
            ...
            this.axios.get(this.listUrl).then((result)=>{
                if(result.data.isSuccess){
                    ...
                    _.forEach(entities, (e)=>{
                        this.list.push(new LocDepartInfoEntity(this, e));
                    });
                    this.fireChange();
                    resolve();
                }else{
    ...
    newEntity(){
        let entity = new LocDepartInfoEntity(this);
        this.list.push(entity);
        return entity;
    }
    save(entity:LocDepartInfoEntity){
        //insert, update
...
export class LocDepartInfoEntity{    
...
this.departName=obj.departName;
this.id=obj.id;
