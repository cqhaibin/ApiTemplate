...
export class ViewModel{
    private entity:LocDutyInfoEntity;
    public createTimeOpt:any;
public dutyNameOpt:any;
public idOpt:any;
public isUseOpt:any;
public levelOpt:any;
...
this.dutyNameOpt.value();
this.idOpt.value(0);
this.isUseOpt.value(0);
this.levelOpt.value(0);
...
this.dutyNameOpt.value(this.entity.dutyName);
this.idOpt.value(this.entity.id);
this.isUseOpt.value(this.entity.isUse);
this.levelOpt.value(this.entity.level);
